...
import { i as isAllowedOrigin, g as getClientIp, r as rateLimitOk, v as verifyTurnstile, e as escapeHtml, a as escapeHtmlList } from './api-security_Cw--SZG9.mjs';
...
const POST = async ({ request }) => {
  try {
    ...
    const list = (arr) => escapeHtmlList(arr);
